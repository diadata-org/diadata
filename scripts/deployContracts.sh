...
# Project version
VERSION='0.1.0'
# Set this flag empty for global commands or npx for local version
n=''
...
dt=$($n zos create DIAToken --network $NETWORK --init initialize --args $OWNER -v)
d=$($n zos create Dispute --network $NETWORK --init initialize --args $dt -v)
