...
var DIADfynOracleBin = ""
...
func DeployDIADfynOracle(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *DIADfynOracle, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADfynOracleABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(DIADfynOracleBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &DIADfynOracle{DIADfynOracleCaller: DIADfynOracleCaller{contract: contract}, DIADfynOracleTransactor: DIADfynOracleTransactor{contract: contract}, DIADfynOracleFilterer: DIADfynOracleFilterer{contract: contract}}, nil
}
...
// DIADfynOracleSession is an auto generated Go binding around an Ethereum contract,
...
// DIADfynOracleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// DIADfynOracleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewDIADfynOracle(address common.Address, backend bind.ContractBackend) (*DIADfynOracle, error) {
	contract, err := bindDIADfynOracle(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &DIADfynOracle{DIADfynOracleCaller: DIADfynOracleCaller{contract: contract}, DIADfynOracleTransactor: DIADfynOracleTransactor{contract: contract}, DIADfynOracleFilterer: DIADfynOracleFilterer{contract: contract}}, nil
}
...
func NewDIADfynOracleCaller(address common.Address, caller bind.ContractCaller) (*DIADfynOracleCaller, error) {
	contract, err := bindDIADfynOracle(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &DIADfynOracleCaller{contract: contract}, nil
}
...
func NewDIADfynOracleTransactor(address common.Address, transactor bind.ContractTransactor) (*DIADfynOracleTransactor, error) {
	contract, err := bindDIADfynOracle(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &DIADfynOracleTransactor{contract: contract}, nil
}
...
func NewDIADfynOracleFilterer(address common.Address, filterer bind.ContractFilterer) (*DIADfynOracleFilterer, error) {
	contract, err := bindDIADfynOracle(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &DIADfynOracleFilterer{contract: contract}, nil
}

// bindDIADfynOracle binds a generic wrapper to an already deployed contract.
func bindDIADfynOracle(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADfynOracleABI))
	if err != nil {
		return nil, err
	}
...
func (_DIADfynOracle *DIADfynOracleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADfynOracle.Contract.DIADfynOracleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADfynOracle *DIADfynOracleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.DIADfynOracleTransactor.contract.Transfer(opts)
}
...
func (_DIADfynOracle *DIADfynOracleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.DIADfynOracleTransactor.contract.Transact(opts, method, params...)
}
...
func (_DIADfynOracle *DIADfynOracleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADfynOracle.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADfynOracle *DIADfynOracleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.contract.Transfer(opts)
}
...
func (_DIADfynOracle *DIADfynOracleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.contract.Transact(opts, method, params...)
}
...
func (_DIADfynOracle *DIADfynOracleCaller) GetValue(opts *bind.CallOpts, key string) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _DIADfynOracle.contract.Call(opts, &out, "getValue", key)
...
func (_DIADfynOracle *DIADfynOracleSession) GetValue(key string) (*big.Int, *big.Int, error) {
	return _DIADfynOracle.Contract.GetValue(&_DIADfynOracle.CallOpts, key)
}
...
func (_DIADfynOracle *DIADfynOracleCaller) Values(opts *bind.CallOpts, arg0 string) (*big.Int, error) {
	var out []interface{}
	err := _DIADfynOracle.contract.Call(opts, &out, "values", arg0)
...
func (_DIADfynOracle *DIADfynOracleSession) Values(arg0 string) (*big.Int, error) {
	return _DIADfynOracle.Contract.Values(&_DIADfynOracle.CallOpts, arg0)
}
...
func (_DIADfynOracle *DIADfynOracleTransactor) SetValue(opts *bind.TransactOpts, key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADfynOracle.contract.Transact(opts, "setValue", key, value, timestamp)
}
...
func (_DIADfynOracle *DIADfynOracleSession) SetValue(key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.SetValue(&_DIADfynOracle.TransactOpts, key, value, timestamp)
}
...
func (_DIADfynOracle *DIADfynOracleTransactor) UpdateOracleUpdaterAddress(opts *bind.TransactOpts, newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADfynOracle.contract.Transact(opts, "updateOracleUpdaterAddress", newOracleUpdaterAddress)
}
...
func (_DIADfynOracle *DIADfynOracleSession) UpdateOracleUpdaterAddress(newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADfynOracle.Contract.UpdateOracleUpdaterAddress(&_DIADfynOracle.TransactOpts, newOracleUpdaterAddress)
}
...
func (it *DIADfynOracleOracleUpdateIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADfynOracleOracleUpdate)
...
func (it *DIADfynOracleOracleUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADfynOracleOracleUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADfynOracle *DIADfynOracleFilterer) FilterOracleUpdate(opts *bind.FilterOpts) (*DIADfynOracleOracleUpdateIterator, error) {
	...
	logs, sub, err := _DIADfynOracle.contract.FilterLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return &DIADfynOracleOracleUpdateIterator{contract: _DIADfynOracle.contract, event: "OracleUpdate", logs: logs, sub: sub}, nil
}
...
func (_DIADfynOracle *DIADfynOracleFilterer) WatchOracleUpdate(opts *bind.WatchOpts, sink chan<- *DIADfynOracleOracleUpdate) (event.Subscription, error) {
	...
	logs, sub, err := _DIADfynOracle.contract.WatchLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(DIADfynOracleOracleUpdate)
				if err := _DIADfynOracle.contract.UnpackLog(event, "OracleUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *DIADfynOracleUpdaterAddressChangeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADfynOracleUpdaterAddressChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *DIADfynOracleUpdaterAddressChangeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADfynOracleUpdaterAddressChangeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADfynOracle *DIADfynOracleFilterer) FilterUpdaterAddressChange(opts *bind.FilterOpts) (*DIADfynOracleUpdaterAddressChangeIterator, error) {
	...
	logs, sub, err := _DIADfynOracle.contract.FilterLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return &DIADfynOracleUpdaterAddressChangeIterator{contract: _DIADfynOracle.contract, event: "UpdaterAddressChange", logs: logs, sub: sub}, nil
}
...
func (_DIADfynOracle *DIADfynOracleFilterer) WatchUpdaterAddressChange(opts *bind.WatchOpts, sink chan<- *DIADfynOracleUpdaterAddressChange) (event.Subscription, error) {
	...
	logs, sub, err := _DIADfynOracle.contract.WatchLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DIADfynOracleUpdaterAddressChange)
				if err := _DIADfynOracle.contract.UnpackLog(event, "UpdaterAddressChange", log); err != nil {
					return err
				}
				event.Raw = log
