...
// func (db *DB) SetAvailableRates( string, rate InterestRate) error {
// 	key := "dia_available_rates_" + rate
// 	var ir =
// 	return db.redisClient.Set(key, &ir, 0).Err()
// }

// // SetAvailablePairsForExchange stores a json containing all pairs available in the exchange in the internal redis db
// func (db *DB) GetAvailableRates(exchange string) ([]InterestRate, error) {
