# DIA Data Oracles on xDai

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on xDai. DIA offers cryptocurrency and data about traditional financial assets.
...
All asset prices are determined in USD with 5 decimals.
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `Ethereum`) using a smart contract.
...
| :------------ | :------------------------------------------: | :----------: |
| xDai Chain | `0xcF2374824C2Ff84F07Ff4adcA074dfeDDa5C7569` |    1/day    |
