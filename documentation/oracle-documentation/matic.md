# DIA Data Oracles on Matic

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on Matic. DIA offers cryptocurrency and data about traditional financial assets.
