---
title: DIA Data
description: How to use request data from a DIA Oracle in your Fantom Dapp using smart contracts
---

# DIA Data Oracles on Fantom
...
DApp developers who want to leverage DIA oracles can access the published data on Fantom.
...
You can interact with our contract in the [blockchain explorer](https://ftmscan.com/address/0xc5ca9c52d3d8d7f9bb17beeb85c2c3d119ab504f), where you can query for any supported asset.
...
On Fantom, you can initialize the oracle address in your wrapper contract by calling `setOracleAddress()` with the address of our deployed demo contract `0xC5cA9C52d3D8d7f9Bb17BeeB85c2C3D119ab504f`.
...
| :------------ | :------------------------------------------: | :----------: |
| Fantom      | `0xC5cA9C52d3D8d7f9Bb17BeeB85c2C3D119ab504f` |    1/day    |
