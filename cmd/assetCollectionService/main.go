...
func NewAssetScraper(exchange string, secret string, relDB *models.RelDB) source.AssetSource {
	...
	case dia.UniswapExchangeArbitrum:
		return source.NewUniswapAssetSource(exchanges[dia.UniswapExchangeArbitrum], relDB)
	...
	case dia.UniswapExchangeV4Base:
		return source.NewUniswapV4AssetSource(exchanges[dia.UniswapExchangeV4Base], relDB)
