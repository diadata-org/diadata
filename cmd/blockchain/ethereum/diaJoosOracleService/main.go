...
import (
	...
	"flag"
	"fmt"
	diaCoingeckoOracleService2 "github.com/diadata-org/diadata/internal/blockchain-scrapers/blockchains/ethereum/diaCoingeckoOracleService"
	"log"
	"math/big"
	"os"
	"strings"
...
func periodicOracleUpdateHelper(sleepSeconds int, auth *bind.TransactOpts, contract *diaCoingeckoOracleService2.DIACoingeckoOracle, conn *ethclient.Client) error {
