...
func main() {
	...
	var secretsFile = flag.String("secretsFile", "/run/secrets/oracle_keys_bodh_aurora", "File with wallet secrets")
	var blockchainNode = flag.String("blockchainNode", "https://mainnet.aurora.dev", "Node address for blockchain connection")
	...
	var chainId = flag.Int64("chainId", 1313161554, "Chain-ID of the network to connect to")
	flag.Parse()
