module github.com/diadata-org/diadata/exchange-scrapers/generic-collector/kucoin

go 1.17

require (
	github.com/diadata-org/diadata v1.4.1-rc-391
...
require (
	...
	github.com/streamingfast/solana-go v0.3.0 // indirect
