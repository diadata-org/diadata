...
// SpawnSOFRScraper returns a new SOFRScraper initialized with default values.
// The instance is asynchronously scraping as soon as it is created.
func SpawnSOFRScraper(datastore models.Datastore) *SOFRScraper {
	s := &SOFRScraper{
	...
	log.Info("SOFR scraper is built and triggered")
	go s.mainLoop()
	return s
}
...
func (s *SOFRScraper) Channel() chan *models.InterestRate {
