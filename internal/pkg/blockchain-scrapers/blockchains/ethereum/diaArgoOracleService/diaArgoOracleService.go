...
var DIAArgoOracleBin = ""
...
func DeployDIAArgoOracle(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *DIAArgoOracle, error) {
	parsed, err := abi.JSON(strings.NewReader(DIAArgoOracleABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(DIAArgoOracleBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &DIAArgoOracle{DIAArgoOracleCaller: DIAArgoOracleCaller{contract: contract}, DIAArgoOracleTransactor: DIAArgoOracleTransactor{contract: contract}, DIAArgoOracleFilterer: DIAArgoOracleFilterer{contract: contract}}, nil
}
...
// DIAArgoOracleSession is an auto generated Go binding around an Ethereum contract,
...
// DIAArgoOracleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// DIAArgoOracleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewDIAArgoOracle(address common.Address, backend bind.ContractBackend) (*DIAArgoOracle, error) {
	contract, err := bindDIAArgoOracle(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracle{DIAArgoOracleCaller: DIAArgoOracleCaller{contract: contract}, DIAArgoOracleTransactor: DIAArgoOracleTransactor{contract: contract}, DIAArgoOracleFilterer: DIAArgoOracleFilterer{contract: contract}}, nil
}
...
func NewDIAArgoOracleCaller(address common.Address, caller bind.ContractCaller) (*DIAArgoOracleCaller, error) {
	contract, err := bindDIAArgoOracle(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracleCaller{contract: contract}, nil
}
...
func NewDIAArgoOracleTransactor(address common.Address, transactor bind.ContractTransactor) (*DIAArgoOracleTransactor, error) {
	contract, err := bindDIAArgoOracle(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracleTransactor{contract: contract}, nil
}
...
func NewDIAArgoOracleFilterer(address common.Address, filterer bind.ContractFilterer) (*DIAArgoOracleFilterer, error) {
	contract, err := bindDIAArgoOracle(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracleFilterer{contract: contract}, nil
}

// bindDIAArgoOracle binds a generic wrapper to an already deployed contract.
func bindDIAArgoOracle(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(DIAArgoOracleABI))
	if err != nil {
		return nil, err
	}
...
func (_DIAArgoOracle *DIAArgoOracleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIAArgoOracle.Contract.DIAArgoOracleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIAArgoOracle *DIAArgoOracleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.DIAArgoOracleTransactor.contract.Transfer(opts)
}
...
func (_DIAArgoOracle *DIAArgoOracleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.DIAArgoOracleTransactor.contract.Transact(opts, method, params...)
}
...
func (_DIAArgoOracle *DIAArgoOracleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIAArgoOracle.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIAArgoOracle *DIAArgoOracleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.contract.Transfer(opts)
}
...
func (_DIAArgoOracle *DIAArgoOracleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.contract.Transact(opts, method, params...)
}
...
func (_DIAArgoOracle *DIAArgoOracleCaller) GetValue(opts *bind.CallOpts, key string) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _DIAArgoOracle.contract.Call(opts, &out, "getValue", key)
...
func (_DIAArgoOracle *DIAArgoOracleSession) GetValue(key string) (*big.Int, *big.Int, error) {
	return _DIAArgoOracle.Contract.GetValue(&_DIAArgoOracle.CallOpts, key)
}
...
func (_DIAArgoOracle *DIAArgoOracleCaller) Values(opts *bind.CallOpts, arg0 string) (*big.Int, error) {
	var out []interface{}
	err := _DIAArgoOracle.contract.Call(opts, &out, "values", arg0)
...
func (_DIAArgoOracle *DIAArgoOracleSession) Values(arg0 string) (*big.Int, error) {
	return _DIAArgoOracle.Contract.Values(&_DIAArgoOracle.CallOpts, arg0)
}
...
func (_DIAArgoOracle *DIAArgoOracleTransactor) SetValue(opts *bind.TransactOpts, key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIAArgoOracle.contract.Transact(opts, "setValue", key, value, timestamp)
}
...
func (_DIAArgoOracle *DIAArgoOracleSession) SetValue(key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.SetValue(&_DIAArgoOracle.TransactOpts, key, value, timestamp)
}
...
func (_DIAArgoOracle *DIAArgoOracleTransactor) UpdateOracleUpdaterAddress(opts *bind.TransactOpts, newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIAArgoOracle.contract.Transact(opts, "updateOracleUpdaterAddress", newOracleUpdaterAddress)
}
...
func (_DIAArgoOracle *DIAArgoOracleSession) UpdateOracleUpdaterAddress(newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIAArgoOracle.Contract.UpdateOracleUpdaterAddress(&_DIAArgoOracle.TransactOpts, newOracleUpdaterAddress)
}
...
func (it *DIAArgoOracleOracleUpdateIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIAArgoOracleOracleUpdate)
...
func (it *DIAArgoOracleOracleUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIAArgoOracleOracleUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIAArgoOracle *DIAArgoOracleFilterer) FilterOracleUpdate(opts *bind.FilterOpts) (*DIAArgoOracleOracleUpdateIterator, error) {
	...
	logs, sub, err := _DIAArgoOracle.contract.FilterLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracleOracleUpdateIterator{contract: _DIAArgoOracle.contract, event: "OracleUpdate", logs: logs, sub: sub}, nil
}
...
func (_DIAArgoOracle *DIAArgoOracleFilterer) WatchOracleUpdate(opts *bind.WatchOpts, sink chan<- *DIAArgoOracleOracleUpdate) (event.Subscription, error) {
	...
	logs, sub, err := _DIAArgoOracle.contract.WatchLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(DIAArgoOracleOracleUpdate)
				if err := _DIAArgoOracle.contract.UnpackLog(event, "OracleUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *DIAArgoOracleUpdaterAddressChangeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIAArgoOracleUpdaterAddressChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *DIAArgoOracleUpdaterAddressChangeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIAArgoOracleUpdaterAddressChangeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIAArgoOracle *DIAArgoOracleFilterer) FilterUpdaterAddressChange(opts *bind.FilterOpts) (*DIAArgoOracleUpdaterAddressChangeIterator, error) {
	...
	logs, sub, err := _DIAArgoOracle.contract.FilterLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return &DIAArgoOracleUpdaterAddressChangeIterator{contract: _DIAArgoOracle.contract, event: "UpdaterAddressChange", logs: logs, sub: sub}, nil
}
...
func (_DIAArgoOracle *DIAArgoOracleFilterer) WatchUpdaterAddressChange(opts *bind.WatchOpts, sink chan<- *DIAArgoOracleUpdaterAddressChange) (event.Subscription, error) {
	...
	logs, sub, err := _DIAArgoOracle.contract.WatchLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DIAArgoOracleUpdaterAddressChange)
				if err := _DIAArgoOracle.contract.UnpackLog(event, "UpdaterAddressChange", log); err != nil {
					return err
				}
				event.Raw = log
