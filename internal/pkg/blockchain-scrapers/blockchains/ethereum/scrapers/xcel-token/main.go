...
var (
	...
	ownerAddress = "0xa14c3b52568f6fd87169d0324c59a285d4287828"
	teamTokens   = "0x24ae479260c040c48fb15c9f5af174a265577251"
)
...
func main() {
	...
	for {
		...
		teamSupply, err := token.BalanceOf(nil, common.HexToAddress(teamTokens))
		if err != nil {
			log.Fatalf("Failed to retrieve token frozenSupply: %v", err)
		}

		tmpSupply := supply.Sub(supply, ownerSupply)
		resultSupply := supply.Sub(tmpSupply, teamSupply)
