...
package diaDefi100OracleService
...
var DIADefi100OracleBin = ""
...
func DeployDIADefi100Oracle(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *DIADefi100Oracle, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADefi100OracleABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(DIADefi100OracleBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &DIADefi100Oracle{DIADefi100OracleCaller: DIADefi100OracleCaller{contract: contract}, DIADefi100OracleTransactor: DIADefi100OracleTransactor{contract: contract}, DIADefi100OracleFilterer: DIADefi100OracleFilterer{contract: contract}}, nil
}
...
// DIADefi100OracleSession is an auto generated Go binding around an Ethereum contract,
...
// DIADefi100OracleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// DIADefi100OracleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewDIADefi100Oracle(address common.Address, backend bind.ContractBackend) (*DIADefi100Oracle, error) {
	contract, err := bindDIADefi100Oracle(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &DIADefi100Oracle{DIADefi100OracleCaller: DIADefi100OracleCaller{contract: contract}, DIADefi100OracleTransactor: DIADefi100OracleTransactor{contract: contract}, DIADefi100OracleFilterer: DIADefi100OracleFilterer{contract: contract}}, nil
}
...
func NewDIADefi100OracleCaller(address common.Address, caller bind.ContractCaller) (*DIADefi100OracleCaller, error) {
	contract, err := bindDIADefi100Oracle(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &DIADefi100OracleCaller{contract: contract}, nil
}
...
func NewDIADefi100OracleTransactor(address common.Address, transactor bind.ContractTransactor) (*DIADefi100OracleTransactor, error) {
	contract, err := bindDIADefi100Oracle(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &DIADefi100OracleTransactor{contract: contract}, nil
}
...
func NewDIADefi100OracleFilterer(address common.Address, filterer bind.ContractFilterer) (*DIADefi100OracleFilterer, error) {
	contract, err := bindDIADefi100Oracle(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &DIADefi100OracleFilterer{contract: contract}, nil
}

// bindDIADefi100Oracle binds a generic wrapper to an already deployed contract.
func bindDIADefi100Oracle(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADefi100OracleABI))
	if err != nil {
		return nil, err
	}
...
func (_DIADefi100Oracle *DIADefi100OracleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADefi100Oracle.Contract.DIADefi100OracleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADefi100Oracle *DIADefi100OracleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.DIADefi100OracleTransactor.contract.Transfer(opts)
}
...
func (_DIADefi100Oracle *DIADefi100OracleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.DIADefi100OracleTransactor.contract.Transact(opts, method, params...)
}
...
func (_DIADefi100Oracle *DIADefi100OracleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADefi100Oracle.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADefi100Oracle *DIADefi100OracleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.contract.Transfer(opts)
}
...
func (_DIADefi100Oracle *DIADefi100OracleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.contract.Transact(opts, method, params...)
}
...
func (_DIADefi100Oracle *DIADefi100OracleCaller) GetValue(opts *bind.CallOpts, key string) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _DIADefi100Oracle.contract.Call(opts, &out, "getValue", key)
...
func (_DIADefi100Oracle *DIADefi100OracleSession) GetValue(key string) (*big.Int, *big.Int, error) {
	return _DIADefi100Oracle.Contract.GetValue(&_DIADefi100Oracle.CallOpts, key)
}
...
func (_DIADefi100Oracle *DIADefi100OracleCaller) Values(opts *bind.CallOpts, arg0 string) (*big.Int, error) {
	var out []interface{}
	err := _DIADefi100Oracle.contract.Call(opts, &out, "values", arg0)
...
func (_DIADefi100Oracle *DIADefi100OracleSession) Values(arg0 string) (*big.Int, error) {
	return _DIADefi100Oracle.Contract.Values(&_DIADefi100Oracle.CallOpts, arg0)
}
...
func (_DIADefi100Oracle *DIADefi100OracleTransactor) SetValue(opts *bind.TransactOpts, key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADefi100Oracle.contract.Transact(opts, "setValue", key, value, timestamp)
}
...
func (_DIADefi100Oracle *DIADefi100OracleSession) SetValue(key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.SetValue(&_DIADefi100Oracle.TransactOpts, key, value, timestamp)
}
...
func (_DIADefi100Oracle *DIADefi100OracleTransactor) UpdateOracleUpdaterAddress(opts *bind.TransactOpts, newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADefi100Oracle.contract.Transact(opts, "updateOracleUpdaterAddress", newOracleUpdaterAddress)
}
...
func (_DIADefi100Oracle *DIADefi100OracleSession) UpdateOracleUpdaterAddress(newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADefi100Oracle.Contract.UpdateOracleUpdaterAddress(&_DIADefi100Oracle.TransactOpts, newOracleUpdaterAddress)
}
...
func (it *DIADefi100OracleOracleUpdateIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADefi100OracleOracleUpdate)
...
func (it *DIADefi100OracleOracleUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADefi100OracleOracleUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADefi100Oracle *DIADefi100OracleFilterer) FilterOracleUpdate(opts *bind.FilterOpts) (*DIADefi100OracleOracleUpdateIterator, error) {
	...
	logs, sub, err := _DIADefi100Oracle.contract.FilterLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return &DIADefi100OracleOracleUpdateIterator{contract: _DIADefi100Oracle.contract, event: "OracleUpdate", logs: logs, sub: sub}, nil
}
...
func (_DIADefi100Oracle *DIADefi100OracleFilterer) WatchOracleUpdate(opts *bind.WatchOpts, sink chan<- *DIADefi100OracleOracleUpdate) (event.Subscription, error) {
	...
	logs, sub, err := _DIADefi100Oracle.contract.WatchLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(DIADefi100OracleOracleUpdate)
				if err := _DIADefi100Oracle.contract.UnpackLog(event, "OracleUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *DIADefi100OracleUpdaterAddressChangeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADefi100OracleUpdaterAddressChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *DIADefi100OracleUpdaterAddressChangeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADefi100OracleUpdaterAddressChangeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADefi100Oracle *DIADefi100OracleFilterer) FilterUpdaterAddressChange(opts *bind.FilterOpts) (*DIADefi100OracleUpdaterAddressChangeIterator, error) {
	...
	logs, sub, err := _DIADefi100Oracle.contract.FilterLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return &DIADefi100OracleUpdaterAddressChangeIterator{contract: _DIADefi100Oracle.contract, event: "UpdaterAddressChange", logs: logs, sub: sub}, nil
}
...
func (_DIADefi100Oracle *DIADefi100OracleFilterer) WatchUpdaterAddressChange(opts *bind.WatchOpts, sink chan<- *DIADefi100OracleUpdaterAddressChange) (event.Subscription, error) {
	...
	logs, sub, err := _DIADefi100Oracle.contract.WatchLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DIADefi100OracleUpdaterAddressChange)
				if err := _DIADefi100Oracle.contract.UnpackLog(event, "UpdaterAddressChange", log); err != nil {
					return err
				}
				event.Raw = log
