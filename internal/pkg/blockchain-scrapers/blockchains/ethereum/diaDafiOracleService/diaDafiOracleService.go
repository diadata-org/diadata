...
var DIADafiOracleBin = ""
...
func DeployDIADafiOracle(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *DIADafiOracle, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADafiOracleABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(DIADafiOracleBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &DIADafiOracle{DIADafiOracleCaller: DIADafiOracleCaller{contract: contract}, DIADafiOracleTransactor: DIADafiOracleTransactor{contract: contract}, DIADafiOracleFilterer: DIADafiOracleFilterer{contract: contract}}, nil
}
...
// DIADafiOracleSession is an auto generated Go binding around an Ethereum contract,
...
// DIADafiOracleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// DIADafiOracleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewDIADafiOracle(address common.Address, backend bind.ContractBackend) (*DIADafiOracle, error) {
	contract, err := bindDIADafiOracle(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &DIADafiOracle{DIADafiOracleCaller: DIADafiOracleCaller{contract: contract}, DIADafiOracleTransactor: DIADafiOracleTransactor{contract: contract}, DIADafiOracleFilterer: DIADafiOracleFilterer{contract: contract}}, nil
}
...
func NewDIADafiOracleCaller(address common.Address, caller bind.ContractCaller) (*DIADafiOracleCaller, error) {
	contract, err := bindDIADafiOracle(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &DIADafiOracleCaller{contract: contract}, nil
}
...
func NewDIADafiOracleTransactor(address common.Address, transactor bind.ContractTransactor) (*DIADafiOracleTransactor, error) {
	contract, err := bindDIADafiOracle(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &DIADafiOracleTransactor{contract: contract}, nil
}
...
func NewDIADafiOracleFilterer(address common.Address, filterer bind.ContractFilterer) (*DIADafiOracleFilterer, error) {
	contract, err := bindDIADafiOracle(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &DIADafiOracleFilterer{contract: contract}, nil
}

// bindDIADafiOracle binds a generic wrapper to an already deployed contract.
func bindDIADafiOracle(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(DIADafiOracleABI))
	if err != nil {
		return nil, err
	}
...
func (_DIADafiOracle *DIADafiOracleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADafiOracle.Contract.DIADafiOracleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADafiOracle *DIADafiOracleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.DIADafiOracleTransactor.contract.Transfer(opts)
}
...
func (_DIADafiOracle *DIADafiOracleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.DIADafiOracleTransactor.contract.Transact(opts, method, params...)
}
...
func (_DIADafiOracle *DIADafiOracleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _DIADafiOracle.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_DIADafiOracle *DIADafiOracleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.contract.Transfer(opts)
}
...
func (_DIADafiOracle *DIADafiOracleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.contract.Transact(opts, method, params...)
}
...
func (_DIADafiOracle *DIADafiOracleCaller) GetValue(opts *bind.CallOpts, key string) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _DIADafiOracle.contract.Call(opts, &out, "getValue", key)
...
func (_DIADafiOracle *DIADafiOracleSession) GetValue(key string) (*big.Int, *big.Int, error) {
	return _DIADafiOracle.Contract.GetValue(&_DIADafiOracle.CallOpts, key)
}
...
func (_DIADafiOracle *DIADafiOracleCaller) Values(opts *bind.CallOpts, arg0 string) (*big.Int, error) {
	var out []interface{}
	err := _DIADafiOracle.contract.Call(opts, &out, "values", arg0)
...
func (_DIADafiOracle *DIADafiOracleSession) Values(arg0 string) (*big.Int, error) {
	return _DIADafiOracle.Contract.Values(&_DIADafiOracle.CallOpts, arg0)
}
...
func (_DIADafiOracle *DIADafiOracleTransactor) SetValue(opts *bind.TransactOpts, key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADafiOracle.contract.Transact(opts, "setValue", key, value, timestamp)
}
...
func (_DIADafiOracle *DIADafiOracleSession) SetValue(key string, value *big.Int, timestamp *big.Int) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.SetValue(&_DIADafiOracle.TransactOpts, key, value, timestamp)
}
...
func (_DIADafiOracle *DIADafiOracleTransactor) UpdateOracleUpdaterAddress(opts *bind.TransactOpts, newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADafiOracle.contract.Transact(opts, "updateOracleUpdaterAddress", newOracleUpdaterAddress)
}
...
func (_DIADafiOracle *DIADafiOracleSession) UpdateOracleUpdaterAddress(newOracleUpdaterAddress common.Address) (*types.Transaction, error) {
	return _DIADafiOracle.Contract.UpdateOracleUpdaterAddress(&_DIADafiOracle.TransactOpts, newOracleUpdaterAddress)
}
...
func (it *DIADafiOracleOracleUpdateIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADafiOracleOracleUpdate)
...
func (it *DIADafiOracleOracleUpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADafiOracleOracleUpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADafiOracle *DIADafiOracleFilterer) FilterOracleUpdate(opts *bind.FilterOpts) (*DIADafiOracleOracleUpdateIterator, error) {
	...
	logs, sub, err := _DIADafiOracle.contract.FilterLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return &DIADafiOracleOracleUpdateIterator{contract: _DIADafiOracle.contract, event: "OracleUpdate", logs: logs, sub: sub}, nil
}
...
func (_DIADafiOracle *DIADafiOracleFilterer) WatchOracleUpdate(opts *bind.WatchOpts, sink chan<- *DIADafiOracleOracleUpdate) (event.Subscription, error) {
	...
	logs, sub, err := _DIADafiOracle.contract.WatchLogs(opts, "OracleUpdate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(DIADafiOracleOracleUpdate)
				if err := _DIADafiOracle.contract.UnpackLog(event, "OracleUpdate", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *DIADafiOracleUpdaterAddressChangeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DIADafiOracleUpdaterAddressChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *DIADafiOracleUpdaterAddressChangeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DIADafiOracleUpdaterAddressChangeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_DIADafiOracle *DIADafiOracleFilterer) FilterUpdaterAddressChange(opts *bind.FilterOpts) (*DIADafiOracleUpdaterAddressChangeIterator, error) {
	...
	logs, sub, err := _DIADafiOracle.contract.FilterLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return &DIADafiOracleUpdaterAddressChangeIterator{contract: _DIADafiOracle.contract, event: "UpdaterAddressChange", logs: logs, sub: sub}, nil
}
...
func (_DIADafiOracle *DIADafiOracleFilterer) WatchUpdaterAddressChange(opts *bind.WatchOpts, sink chan<- *DIADafiOracleUpdaterAddressChange) (event.Subscription, error) {
	...
	logs, sub, err := _DIADafiOracle.contract.WatchLogs(opts, "UpdaterAddressChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DIADafiOracleUpdaterAddressChange)
				if err := _DIADafiOracle.contract.UnpackLog(event, "UpdaterAddressChange", log); err != nil {
					return err
				}
				event.Raw = log
