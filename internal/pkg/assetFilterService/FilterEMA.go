...
type FilterEMA struct {
	...
	lastTrade       *dia.AssetFilterPoint
	param           int
	value           float64
	modified        bool
	filterName      string
...
func (s *FilterEMA) Compute(trade dia.AssetFilterPoint) {
	s.compute(trade)
}
...
func (e *FilterEMA) fill(t time.Time, trade dia.AssetFilterPoint) {
...
func (e *FilterEMA) FilterPointForBlock() *dia.AssetFilterPoint {
...
func (s *FilterEMA) filterPointForBlock() *dia.AssetFilterPoint {
