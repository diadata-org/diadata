...
import (
	...
	zerox2 "github.com/diadata-org/diadata/internal/exchange-scrapers/zerox"
	token2 "github.com/diadata-org/diadata/internal/exchange-scrapers/zerox/token"
...
func (scraper *ZeroxScraper) subscribeToTrades() error {
	...
	sink := make(chan *zerox2.ZeroxFill)
